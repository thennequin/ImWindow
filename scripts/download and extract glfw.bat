...
if not exist "%~dp0\glfw-3.2.1.bin.WIN32.zip" (
	...
	powershell Invoke-WebRequest -Uri "https://github.com/glfw/glfw/releases/download/3.2.1/glfw-3.2.1.bin.WIN32.zip" -OutFile '%~dp0\glfw-3.2.1.bin.WIN32.zip'
)
if not exist "%~dp0\glfw-3.2.1.bin.WIN64.zip" (
	echo Downloading GLFW 3.2.1 WIN64...
	powershell Invoke-WebRequest -Uri "https://github.com/glfw/glfw/releases/download/3.2.1/glfw-3.2.1.bin.WIN64.zip" -OutFile '%~dp0\glfw-3.2.1.bin.WIN64.zip'
)
